...
AS BEGIN  
 ...
 UPDATE V SET   
  V.ENumber = CASE WHEN V.StatusCode <> 300 THEN T1.ENumber ELSE V.ENumber END,  
  V.VarietyName = CASE WHEN V.StatusCode <> 300 THEN T1.VarietyName ELSE V.VarietyName END,  
  V.StatusCode = CASE   
	...
	,V.VarmasStatusCode = CASE WHEN V.StatusCode <> 300 THEN S.StatusCode ELSE V.VarmasStatusCode END
