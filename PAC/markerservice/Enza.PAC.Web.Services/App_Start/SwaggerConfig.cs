...
using Enza.PAC.Web.Services.Core.Attributes;
using System.IO;
...
namespace Enza.PAC.Web.Services
{
    public class SwaggerConfig
    {
            ...
            config.EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "Enza.PAC.Web.Services");
        ...
        {
            var xmlFile = Path.Combine(System.Web.HttpRuntime.BinDirectory, "Enza.PAC.Web.Services.xml");
            return xmlFile;
        }
    }
}
