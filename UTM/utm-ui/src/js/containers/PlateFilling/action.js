...
export const filelistFetch = (breeding, crop, testTypeMenu) => ({
  type: 'FILELIST_FETCH',
  breeding,
  crop,
  testTypeMenu
...
export const fetchTestlookup = (breedingStationCode, cropCode, testTypeMenu) => ({
...
export const reserveCall = (testID, forced) => ({
