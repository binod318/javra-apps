...
class SHResultComponent extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      tblWidth: 0,
  ...
  render() {
    ...
    const columnsMapping = {
      ...
      sampleType: { name: 'Sample Type', filter: true, fixed: true },
...
SHResultComponent.defaultProps = {
  result: [],
  total: 0,
  filter: []
};
SHResultComponent.propTypes = {
...
export default SHResultComponent;
