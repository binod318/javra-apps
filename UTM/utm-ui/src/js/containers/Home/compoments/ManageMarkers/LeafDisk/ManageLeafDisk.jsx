...
// component
class ManageLeafDisk extends Component {
  constructor(props) {
    super(props);
    this.state = {
      currentIndex: 0,
  ...
  componentDidMount() {
    ...
    this.props.fetchLeafDiskSampleData(payload);
              ...
              <Column
                ...
                header={
                  <LDHeaderCell
                    ...
                    fetchData={this.props.fetchLeafDiskSampleData}
                  />
                }
...
const mapStateToProps = state => ({
  ...
  filter: state.assignMarker.leafDiskFilters,
...
const mapDispatchToProps = dispatch => ({
  fetchLeafDiskSampleData: payload => {
    dispatch({ type: "FETCH_LEAF_DISK_SAMPLE_DATA", payload });
  },
  clearFilters: () => dispatch(clearLeafDiskFilters()),
  deleteSample: payload => {
    dispatch({ type: "DELETE_LD_SAMPLE", payload });
  }
});
