...
class ManageDeterminationComponent extends Component {
  ...
  componentDidMount() {
    ...
    this.props.fetchSeedHealthMaterialDeterminations(payload);
    this.props.fetchSeedHealthDeterminations(this.props.cropSelected);
  ...
  componentDidUpdate(prevProps) {
    if (
      this.props.assignSHDetermationSucceeded &&
      prevProps.assignSHDetermationSucceeded !==
        this.props.assignSHDetermationSucceeded
    ) {
      ...
      this.props.resetAssignSHDeterminationSucceededFlag();
    }
    if (
  ...
  assignMarker = () => {
    ...
    this.props.assignSHDeterminations(payload);
    this.props.resetIsColumnMarker();
  };

  saveSHDeterminationsChanged = rowIndex => {
    const filter = Object.values(this.props.filters);
    ...
    this.props.saveSHDeterminationsChanged(payload);
    this.props.resetIsColumnMarker();
        ...
        <div className="trow marker">
          <div className="tcell">
            <div className="markTitle">
              ...
              <button
                onClick={() => this.saveSHDeterminationsChanged()}
                ...
                <Column
                  ...
                  header={
                    <SHHeaderCell
                      ...
                      fetchData={this.props.fetchSeedHealthMaterialDeterminations}
                    />
                  }
                  ...
                  cell={
                    column.columnID === "action" ? (
                      ...
                      <SHTextCell
                        ...
                        onEnter={this.saveSHDeterminationsChanged}
...
const mapStateToProps = state => ({
  ...
  filters: state.assignMarker.seedHealthFilters,
  ...
  assignSHDetermationSucceeded:
    state.assignMarker.determinations.assignSHDetermationSucceeded,
...
const mapDispatchToProps = dispatch => ({
  ...
  fetchSeedHealthDeterminations: cropcode =>
    dispatch({ type: "FETCH_SEED_HEALTH_DETERMINATIONS", cropcode }),
  fetchSeedHealthMaterialDeterminations: payload =>
    dispatch({ type: "FETCH_SEED_HEALTH_MATERIAL_DETERMINATIONS", payload }),
  toggleClick: id => dispatch(markerToggle(id)),
  toggleDetermination: determinationID =>
    dispatch({ type: "TOGGLE_DETERMINATION", determinationID }),
  assignSHDeterminations: payload =>
    dispatch({ type: "ASSIGN_SEED_HEALTH_DETERMINATIONS", payload }),
  saveSHDeterminationsChanged: payload =>
    dispatch({ type: "SAVE_SEED_HEALTH_DETERMINATIONS_CHANGED", payload }),
  resetAssignSHDeterminationSucceededFlag: () =>
    dispatch({ type: "RESET_ASSIGN_SEED_HEALTH_DETERMINATION_SUCCEEDED_FLAG" }),
...
ManageDeterminationComponent.propTypes = {
  ...
  fetchSeedHealthDeterminations: PropTypes.func.isRequired,
  ...
  assignSHDeterminations: PropTypes.func.isRequired,
  fetchSeedHealthMaterialDeterminations: PropTypes.func.isRequired,
  saveSHDeterminationsChanged: PropTypes.func.isRequired,
  ...
  assignSHDetermationSucceeded: PropTypes.bool.isRequired,
  resetAssignSHDeterminationSucceededFlag: PropTypes.func.isRequired,
