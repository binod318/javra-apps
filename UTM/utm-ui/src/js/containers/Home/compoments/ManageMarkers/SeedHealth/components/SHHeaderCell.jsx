...
class HeaderComponent extends Component {
  ...
  handleKeyPress(e) {
    ...
    this.props.addSeedHealthFilter({ key: data.columnID, value: obj });
          ...
          {checkHeaderCondition && (
            <div className="check-all-marker tableCheck">
              <input
                ...
                onChange={this.toggleAllSHMarkers}
              />
...
const mapDispatchToProps = dispatch => ({
  addSeedHealthFilter: payload =>
    dispatch({ type: "ADD_SEED_HEALTH_FILTER", payload }),
  toggleAllSHMarkers: (marker, checkedStatus) =>
    dispatch({
      type: "TOGGLE_ALL_SEED_HEALTH_MARKERS",
      marker,
      checkedStatus
    }),
...
HeaderComponent.propTypes = {
  ...
  toggleAllSHMarkers: PropTypes.func.isRequired,
