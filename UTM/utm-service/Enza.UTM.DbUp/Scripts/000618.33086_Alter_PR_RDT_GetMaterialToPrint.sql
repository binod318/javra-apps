DROP PROCEDURE IF EXISTS [dbo].[PR_RDT_GetMaterialToPrint]
GO
...
CREATE PROCEDURE [dbo].[PR_RDT_GetMaterialToPrint]
(
	@TestID INT,
...
AS BEGIN
	...
	BEGIN
		...
		SELECT TMD.InterfaceRefID AS LimsID, TM.MaterialStatus, TMD.NrPlants, D.DeterminationName, M.MaterialKey, GID, [Plant Name], lotNr, [E-number], MasterNr , T.ImportLevel, T.LabPlatePlanName
		FROM Test T 
