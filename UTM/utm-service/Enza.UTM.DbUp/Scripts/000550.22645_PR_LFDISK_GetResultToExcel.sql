DROP PROCEDURE IF EXISTS PR_LFDISK_GetResultToExcel
GO
/*
...
CREATE PROCEDURE PR_LFDISK_GetResultToExcel
(
	@TestID INT
)
AS
...
SELECT 
	@SelectColumns = COALESCE(@SelectColumns+ ',','') + QUOTENAME(D.DeterminationID) +' AS '+ MAX(DeterminationName),
...
DROP PROCEDURE IF EXISTS PR_LFDISK_Calculate_Sample_Filling
GO
