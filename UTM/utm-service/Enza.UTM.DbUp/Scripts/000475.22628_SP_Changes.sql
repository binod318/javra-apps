DROP PROCEDURE IF EXISTS PR_LFDISK_ImportMaterials
GO
...
AS BEGIN
    ...
    BEGIN TRY
	   ...
	   BEGIN
		  ...
		  [SyncCode], [ImportLevel], CountryCode, TestProtocolID)
		  VALUES(@TestTypeID, @FileID, @Source, @UserID, @TestName, GETUTCDATE(), 100, @BrStationCode, @SyncCode, CASE WHEN ISNULL(@ImportLevel,'') ='Plot' THEN 'Plot' ELSE 'CROSSES/SELECTION' END, @CountryCode, @TestProtocolID);
