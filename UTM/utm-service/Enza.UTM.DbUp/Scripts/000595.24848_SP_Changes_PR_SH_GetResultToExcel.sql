DROP PROCEDURE IF EXISTS PR_SH_GetResultToExcel
GO
/*
Author							Date				Description
Krishna Gautam					2021/11/23			Sp created to export result to excel file.


=================Example===============
EXEC PR_SH_GetResultToExcel 12725;
*/

CREATE PROCEDURE [dbo].[PR_SH_GetResultToExcel]
(
	@TestID INT
)
AS
