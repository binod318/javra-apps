DROP PROCEDURE IF EXISTS PR_LFDISK_Reserve_Capacity
GO
/*
...
BEGIN
	...
	BEGIN TRY
		...
		BEGIN TRANSACTION;
			...
			IF(@InRange = 1) BEGIN
				INSERT INTO Slot(SlotName, PeriodID, StatusCode, CropCode, MaterialTypeID, RequestUser, RequestDate, PlannedDate, BreedingStationCode, Remark,TestTypeId,AlreadyApproved,MaterialStateID)
				VALUES(@SlotName,@PeriodID,200,@CropCode,@MaterialTypeID,@User,GETDATE(),@PlannedDate,@BreedingStationCode, @Remark,@TestTypeID,1,2);
			...
			ELSE IF(@Forced = 1 AND @InRange = 0) BEGIN				
				--create logic here....				
				INSERT INTO Slot(SlotName, PeriodID, StatusCode, CropCode, MaterialTypeID,  RequestUser, RequestDate, PlannedDate, BreedingStationCode,Remark,TestTypeID,MaterialStateID)
				VALUES(@SlotName, @PeriodID, 100, @CropCode, @MaterialTypeID,  @User, GETDATE(), @PlannedDate,  @BreedingStationCode,  @Remark, @TestTypeID,2);
