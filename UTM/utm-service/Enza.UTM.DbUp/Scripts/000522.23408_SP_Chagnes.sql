...
Binod Gurung		2021/06/22			#23409 : Add site location during import.

========Example=============

*/

ALTER PROCEDURE [dbo].[PR_LFDISK_ImportMaterials]
(
	@TestID						INT OUTPUT,
...
AS BEGIN
	...
	BEGIN
		...
		) T ON T.CropCode = S.CropCode AND T.TestTypeID = S.TestTypeID AND T.BreedingStationCode = S.BreedingStationCode AND RC.TestProtocolID = T.TestProtocolID
