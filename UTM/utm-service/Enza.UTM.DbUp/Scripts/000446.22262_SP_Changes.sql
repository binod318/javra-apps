...
DROP PROCEDURE IF EXISTS PR_SaveTestMaterialDetermination_ForRDT
GO

DROP PROCEDURE IF EXISTS PR_SaveTestMaterialDeterminationWithTVP_ForRDT
GO

DROP TYPE [dbo].[TVP_TMD_WithDate]
GO
...
AS BEGIN
	...
	SELECT 
		...
		@UpdateMaxSelect = CASE WHEN T.StatusCode BETWEEN 500 AND 549 THEN 1 ELSE 0 END,
