...
(
	...
	UPDATE SET 
			...
			T.MinPercent = (CASE WHEN ISNULL(S.MappingCol,'') = 'SusceptibilityPer' THEN S.MinPercent ELSE NULL END),
			T.MaxPercent = (CASE WHEN ISNULL(S.MappingCol,'') = 'SusceptibilityPer' THEN S.MaxPercent ELSE NULL END),
	...
	(
		...
		(CASE WHEN ISNULL(S.MappingCol,'') = 'SusceptibilityPer' THEN S.MinPercent ELSE NULL END),
		(CASE WHEN ISNULL(S.MappingCol,'') = 'SusceptibilityPer' THEN S.MaxPercent ELSE NULL END),
