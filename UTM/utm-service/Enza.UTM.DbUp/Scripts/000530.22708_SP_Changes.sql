DROP TYPE IF EXISTS TVP_ColumnDetail
GO
...
AS BEGIN
	...
	INSERT INTO @ColumnTable(ColumnID,TraitID,ColumnLabel, DataType,Editable, Visible, [Order],AllowFilter,AllowSort)
	SELECT 
	   ColumnID, 
	   TraitID,
	   ColumLabel,
	...
	BEGIN
		...
		INSERT @ColumnTable(ColumnID, TraitID, ColumnLabel, DataType, Editable, Visible, [Order])
		VALUES(ISNULL(@PlantsColID,0) + 1,NULL,'#plants','integer',1,1,3);
...
BEGIN
	...
	INSERT @ColumnTable(ColumnID, ColumnLabel, [Order], Visible,AllowFilter,DataType,Editable)
