...
namespace Enza.UTM.BusinessAccess.Services
{
    public class TraitDeterminationService : ITraitDeterminationService
    {
        ...
        public Task<DataTable> GetTraitDeterminationResultSeedHealthAsync(TraitDeterminationResultRequestArgs args)
        {
            return repository.GetTraitDeterminationResultSeedHealthAsync(args);
        }

        public async Task<DataTable> SaveTraitDeterminationResultSeedHealthAsync(SeedHealthSaveTraitDeterminationResultRequestArgs requestArgs)
        {
            await repository.SaveTraitDeterminationResultSeedHealthAsync(requestArgs);
            var args = new TraitDeterminationResultRequestArgs
            {
                Crops = requestArgs.Crops,
                Filter = requestArgs.Filter,
            ...
            var dt = await GetTraitDeterminationResultSeedHealthAsync(args);
            //return totalrows back to controller
            requestArgs.TotalRows = args.TotalRows;
            return dt;
        }
