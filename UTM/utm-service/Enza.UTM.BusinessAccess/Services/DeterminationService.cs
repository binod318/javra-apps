...
namespace Enza.UTM.BusinessAccess.Services
{
    public class DeterminationService : IDeterminationService
    {
        ...
        public Task<IEnumerable<DeterminationResult>> GetLeafDiskDeterminationAsync(string cropCode)
        {
            return repository.GetLeafDiskDeterminationAsync(cropCode);
        }
        public Task<IEnumerable<DeterminationResult>> GetSeedHealthDeterminationAsync(string cropCode)
        {
            return repository.GetSeedHealthDeterminationAsync(cropCode);
        }
    }
}
