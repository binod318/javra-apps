...
namespace Enza.UTM.BusinessAccess
{
    public class AutofacModule : Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            //Leaf Disk
            builder.RegisterType<LeafDiskRepository>().As<ILeafDiskRepository>().InstancePerLifetimeScope();
            builder.RegisterType<LeafDiskService>().As<ILeafDiskService>().InstancePerLifetimeScope();
            //seed health
            builder.RegisterType<SeedHealthRepository>().As<ISeedHealthRepository>().InstancePerLifetimeScope();
            builder.RegisterType<SeedHealthService>().As<ISeedHealthService>().InstancePerLifetimeScope();
