...
namespace Enza.UTM.BusinessAccess.Interfaces
{
    public interface ITraitDeterminationService
    {
        ...
        Task<DataTable> GetTraitDeterminationResultSeedHealthAsync(TraitDeterminationResultRequestArgs args);

        Task<DataTable> SaveTraitDeterminationResultSeedHealthAsync(SeedHealthSaveTraitDeterminationResultRequestArgs args);
    }
}
