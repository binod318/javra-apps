...
namespace Enza.UTM.BusinessAccess.Interfaces
{
    ...
    public class EmailConfigGroups
    {
        ...
        public const string RDT_TEST_COMPLETE_NOTIFICATION = "RDT_TEST_COMPLETE_NOTIFICATION";
        public const string TEST_COMPLETE_NEGATIVE = "TEST_COMPLETE_NEGATIVE";
        public const string TEST_COMPLETE_POSITIVE = "TEST_COMPLETE_POSITIVE";
    }
}
