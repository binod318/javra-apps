...
namespace Enza.UTM.DataAccess.Data.Interfaces
{
    public interface ITraitDeterminationRepository : IRepository<object>
    {
        ...
        Task<DataTable> GetTraitDeterminationResultSeedHealthAsync(TraitDeterminationResultRequestArgs requestArgs);
        Task SaveTraitDeterminationResultSeedHealthAsync(SeedHealthSaveTraitDeterminationResultRequestArgs requestargs);
    }
}
