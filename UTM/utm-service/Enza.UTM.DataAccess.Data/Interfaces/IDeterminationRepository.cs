...
namespace Enza.UTM.DataAccess.Data.Interfaces
{
    public interface IDeterminationRepository : IRepository<object>
    {
        ...
        Task<IEnumerable<DeterminationResult>> GetLeafDiskDeterminationAsync(string cropCode);
        Task<IEnumerable<DeterminationResult>> GetSeedHealthDeterminationAsync(string cropCode);
    }
}
