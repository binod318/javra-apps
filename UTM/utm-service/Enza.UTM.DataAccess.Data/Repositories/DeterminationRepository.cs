...
namespace Enza.UTM.DataAccess.Data.Repositories
{
    public class DeterminationRepository : Repository<object>, IDeterminationRepository
    {
        ...
        public async Task<IEnumerable<DeterminationResult>> GetLeafDiskDeterminationAsync(string cropCode)
        {
            return await DbContext.ExecuteReaderAsync(DataConstants.PR_LFDISK_GET_DETERMINATIONS, CommandType.StoredProcedure, args =>
            {
        ...
        public async Task<IEnumerable<DeterminationResult>> GetSeedHealthDeterminationAsync(string cropCode)
        {
            return await DbContext.ExecuteReaderAsync(DataConstants.PR_SH_GET_DETERMINATIONS, CommandType.StoredProcedure, args =>
            {
                args.Add("@CropCode", cropCode);
            }, reader => new DeterminationResult
            {
