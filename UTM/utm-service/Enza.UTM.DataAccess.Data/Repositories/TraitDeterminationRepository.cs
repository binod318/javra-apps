...
namespace Enza.UTM.DataAccess.Data.Repositories
{
    public class TraitDeterminationRepository : Repository<object>, ITraitDeterminationRepository
    {
        ...
        public async Task<DataTable> GetTraitDeterminationResultSeedHealthAsync(TraitDeterminationResultRequestArgs requestArgs)
        {
            var ds = await DbContext.ExecuteDataSetAsync(DataConstants.PR_SH_GET_TRAIT_DETERMINATION_RESULT,
                CommandType.StoredProcedure, args =>
                {
                    args.Add("@PageSize", requestArgs.PageSize);
                    args.Add("@PageNumber", requestArgs.PageNumber);
        ...
        public Task SaveTraitDeterminationResultSeedHealthAsync(SeedHealthSaveTraitDeterminationResultRequestArgs requestArgs)
        {
            return DbContext.ExecuteNonQueryAsync(DataConstants.PR_SH_SAVE_TRAIT_DETERMINATION_RESULT,
                CommandType.StoredProcedure, args =>
                {
                    args.Add("@TVP", requestArgs.ToTvp());
                });
