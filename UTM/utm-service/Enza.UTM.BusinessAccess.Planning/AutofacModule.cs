...
namespace Enza.UTM.BusinessAccess.Planning
{
    public class AutofacModule : Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            //Leaf disk repositories
            builder.RegisterType<LeafDiskCapacityRepository>().As<ILeafDiskCapacityRepository>().InstancePerRequest();
            builder.RegisterType<LeafDiskSlotRepository>().As<ILeafDiskSlotRepository>().InstancePerRequest();
            ...
            //Leaf disk services
            builder.RegisterType<LeafDiskCapacityService>().As<ILeafDiskCapacityService>().InstancePerRequest();
            builder.RegisterType<LeafDiskSlotService>().As<ILeafDiskSlotService>().InstancePerRequest();
