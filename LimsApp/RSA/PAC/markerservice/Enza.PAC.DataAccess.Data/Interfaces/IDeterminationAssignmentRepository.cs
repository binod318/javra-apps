...
{
    public interface IDeterminationAssignmentRepository : IRepository<object>
    {
        Task<JsonResponse> GetDeterminationAssignmentsAsync(GetDeterminationAssignmentsRequestArgs requestArgs);
        Task<DataTable> GetAssignmentsFromABSAsync(GetABSAssignmentsRequestArgs requestArgs);
        Task<DataTable> ConfirmPlanningAsync(ConfirmPlanningRequestArgs requestArgs);
        ...
        Task<IEnumerable<DeterminationAssignment>> GetDAForStatusUpdateAsync(GetDAOverviewRequestArgs requestArgs);
