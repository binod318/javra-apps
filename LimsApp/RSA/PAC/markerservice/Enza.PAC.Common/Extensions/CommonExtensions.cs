...
namespace Enza.PAC.Common.Extensions
{
    public static class CommonExtensions
    {
        ...
        {
            if (string.IsNullOrWhiteSpace(o.ToText()))
        ...
        public static decimal ToDecimal32(this object o)
        {
            if (string.IsNullOrWhiteSpace(o.ToText()))
        ...
        public static int? ToNInt32(this object o)
        {
            if (string.IsNullOrWhiteSpace(o.ToText()))
                return null;
        ...
        public static object ToDateTimeOrDbNull(this object o)
        {
            if (string.IsNullOrWhiteSpace(o.ToText()))
                return DBNull.Value;
        ...
        public static bool ToUBoolean(this object o)
        {
            if (string.IsNullOrWhiteSpace(o.ToText()))
                return false;

            var trueValues = new[] { "1", "y", "yes", "true", "t" };
            return trueValues.Contains(o.ToString(),StringComparer.OrdinalIgnoreCase);
        }
